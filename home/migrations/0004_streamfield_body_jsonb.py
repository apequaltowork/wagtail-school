...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0003_auto_20260922_1015'),
    ]

    operations = [
        migrations.RunSQL(
            sql='ALTER TABLE home_homepage ALTER COLUMN body TYPE jsonb USING body::jsonb',
            reverse_sql='ALTER TABLE home_homepage ALTER COLUMN body TYPE text USING body::text',
        ),
    ]
